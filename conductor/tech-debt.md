...
| 2026-04-23 | agent-orchestration-monitoring_20260423 | WS-01: Hub broadcast panic on closed websocket (partial) | Low | Open | WriteJSON now uses 1s deadline; removed Close() calls to avoid double-close panics. Still needs error recovery or connection state tracking for full robustness. |
