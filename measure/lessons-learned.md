...
- (2026-05-07, data_backup_export_20260506) Export endpoint returns JSON with schema version + timestamp + repos. Import uses schema version validation and confirmation dialog before applying changes. Test with httptest.NewRequest pattern for validating request/response structures.