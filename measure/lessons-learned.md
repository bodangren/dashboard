...
- (2026-05-03, repo_health_monitoring_20260503) GetStaleBranches uses git for-each-ref with committerdate; branch must have a commit to appear in the list. Empty repos have no branches. Test stale branch detection with real commits, not just branch creation.