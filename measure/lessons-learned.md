...
- (2026-05-04, dashboard_customization_20260503) Preferences system using a single JSON object in localStorage with a dedicated preferences.js module allows easy extension. Separate getPreferences/savePreferences/updatePreference functions. applyPreferences() handles CSS attribute-based layout changes.